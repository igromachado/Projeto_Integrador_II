...
create table fabricante(
	id_fabricante int primary key not null auto_increment,
...
create table causa_falha(
	id_causa int primary key not null auto_increment,
...
create table ordem_servico(
	id_ordem int primary key not null auto_increment,
...
create table ordem_tecnico(
	id_ordem_tecnico int primary key not null auto_increment,
...
create table ordem_peca(
	id_ordem_peca int primary key not null auto_increment,
